...
class Program
    {
        static void Main(string[] args)
        {
            List<Student> students = new List<Student>()
            {
                ...
                new Student{ Id = 4, Name = "Chung", Age = 14 },
                new Student{ Id = 5, Name = "Ha", Age = 19 },
                new Student{ Id = 6, Name = "Hung", Age = 20 }
            };
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Khong co du lieu nhap vao. Thoat chuong trinh!");
                    break;
                }
                if (!int.TryParse(input, out choice))
                {
                    Console.WriteLine("Du lieu nhap không hop lệ. Vui long nhap lai!");
                    continue;
                }
